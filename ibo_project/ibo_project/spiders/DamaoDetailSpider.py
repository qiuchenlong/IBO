...
class DamaoDetailSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # print("resp", resp)
        #
        # hxs2 = HtmlXPathSelector(resp)
        # print("hxs2", hxs2)
        #
        # player_url2 = hxs2.select('//iframe/@src').extract()
        # print("player_url2", player_url2)
    ...
    def parse2(self, response):
        ...
        # 爱奇艺
        if "api.47ks.com/webcloud/" in player_url[0]: # https://api.47ks.com/webcloud/?v=http://www.iqiyi.com/v_19rrc9xgk0.html
            ...
            r = requests.get('https://api.47ks.com/webcloud/?v=http://www.iqiyi.com/v_19rrc9xgk0.html', data=data, headers=headers)
    ...
    def parse_aiqiyi_play_url(self, response):
        ...
        k4 = ctx.call('md5', cache_value + vd + "api.47ks.com" + ctx.call('md5', "41d785ff9079cee021d2bb9d715f7582"))
    ...
    def parse_guhuo_play_url(self, response):
        ...
        if matchObj:
            ...
            json_date['tk'] = tks # "UHNHb1lseXFZUUlSTThvcEd6am9hTnBjdTc0cWRNNURNc28yZ3QrRVNGdG03ei9kcG5LUnArRFV0cFZNV3UvcA%3D%3D"
