...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return AppManager.getContext().getResources().getDisplayMetrics();
    }
...
//        clip.setText(string);
//        AppContext.showToast("copy_success"); //R.string.copy_success
//    }
