...
public final class ItemAlignmentFacet {
    ...
    public static class ItemAlignmentDef {
         ...
         * {@link ItemAlignmentFacet.ItemAlignmentDef}s, one with view id R.id.child1, the other with view id
    ...
    private ItemAlignmentFacet.ItemAlignmentDef[] mAlignmentDefs = new ItemAlignmentFacet.ItemAlignmentDef[]{new ItemAlignmentFacet.ItemAlignmentDef()};
